import {
  ...
  SIGN_UP_SUCCESS,
  SIGN_UP_FAIL,
  SIGN_UP_CLEAR, SET_FORM_FILLED, SET_FORM_UNFILLED, SET_API_ERROR, SHOW_POSITIONS_ERROR, CHECK_FORM_FILLED,
...
export const setIsFormFilled = (state) => state.signUp.isFormFilled;
