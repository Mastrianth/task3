...
const useStyles = makeStyles((theme) => ({
  ...
  svgIcon1: {
    ...
    paddingBottom: '20px',
    '&:hover path': {
      fill: '#00BDD3',backgroundColor: 'rgba(0, 189, 211, 0.1)',
    }
  },
  svgIcon2: {
    paddingTop: '5px',
...
const MobileMenu = () => {
  ...
  return (
    <Container className={classes.mainContainer}>
      <Grid direction="row-reverse" className={classes.rightBack} container alignItems="stretch"></Grid>
      <Grid className={classes.logo} ><img className={classes.pupLogo} src={Logo} alt="Logo" /></Grid>
        <Grid direction="column" justify="center" alignItems="flex-start" container>
          <Grid item><img className={classes.userImage} src={userLogo} alt="user logo" /></Grid>
          <Grid item>
        ...
        <Grid container>
          <Grid className={classes.svgIcon4} item>
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M7.09 12.59L8.5 14L13.5 9L8.5 4L7.09 5.41L9.67 8H0V10H9.67L7.09 12.59ZM16 0H2C0.89 0 0 0.9 0 2V6H2V2H16V16H2V12H0V16C0 17.1 0.89 18 2 18H16C17.1 18 18 17.1 18 16V2C18 0.9 17.1 0 16 0Z" fill="#D0CFCF"/>
            </svg>
          </Grid>
          <Grid item>
      ...
      <Grid container>
        <Grid item>
          <Typography style={{paddingTop: '20px'}} className={classes.subTitle}>Information</Typography>
        </Grid>
          {items1.map((item) => (
            <Grid container>
      ...
      <Grid container>
        <Grid item>
          <Typography style={{paddingTop: '20px'}} className={classes.subTitle}>About</Typography>
        </Grid>
        {items2.map((item) => (
          <Grid container>
            <Grid className={classes.svgIcon5} item>
      ...
      <Grid container>
        <Grid item>
          <Typography style={{paddingTop: '20px'}} className={classes.subTitle}>Tools</Typography>
        </Grid>
        {items3.map((item) => (
          <Grid container>
            <Grid className={classes.svgIcon5} item>
      ...
      <Grid container>
        <Grid item>
          <Typography style={{paddingTop: '20px'}} className={classes.subTitle}>Support</Typography>
        </Grid>
        {items4.map((item) => (
          <Grid container>
            <Grid className={classes.svgIcon5} item>
